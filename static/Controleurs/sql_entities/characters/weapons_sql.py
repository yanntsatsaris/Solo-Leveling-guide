...
class WeaponsSql:
    ...
    def delete_weapon_evolution(self, eid):
        self.cursor.execute("DELETE FROM weapon_evolution_translations WHERE weapon_evolution_translations_weapon_evolutions_id=%s", (eid,))
        self.cursor.execute("DELETE FROM weapon_evolutions WHERE weapon_evolutions_id=%s", (eid,))