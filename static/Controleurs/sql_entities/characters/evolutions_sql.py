...
class EvolutionsSql:
    ...
    def get_evolutions(self, char_id, language, type_folder, char_folder):
        ...
        self.cursor.execute("""
            SELECT ce.character_evolution_id, ce.character_evolutions_evolution_id, ce.character_evolutions_number, ce.character_evolutions_type, ce.character_evolutions_range, cet.character_evolution_translations_description
