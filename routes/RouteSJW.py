...
@sjw_bp.route('/SJW/add_shadow/check_image_folder_shadow')
@login_required
...
@sjw_bp.route('/SJW/add_shadow', methods=['POST'])
@login_required
def add_shadow():
...
@sjw_bp.route('/SJW/add_weapon/check_image_folder_weapon')
@login_required
...
@sjw_bp.route('/SJW/add_weapon', methods=['POST'])
@login_required
def add_weapon():
...
@sjw_bp.route('/SJW/edit', methods=['POST'])
@login_required
def edit_sjw():
...
@sjw_bp.route('/SJW/images_for/<folder>')
@login_required
...
@sjw_bp.route('/SJW/add_skill/check_image_folder_skill')
@login_required
...
@sjw_bp.route('/SJW/add_sjw_skill', methods=['POST'])
@login_required
def add_sjw_skill():
